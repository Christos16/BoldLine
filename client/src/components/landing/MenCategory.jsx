...
const LandingPage = () => {
  ...
  useEffect(() => {
    ...
    dispatch(getProducts(variables, 'Men'));
  }, []);
  ...
  //Fetching the clothes based on the "Men" Category
  ...
  return (
    <div className='font-italic' data-set='MenCategory'>
      <div className='container'>
        ...
        <div class='row'>
          <div class='col-sm-4'>
            ...
            <Checkbox
              handleFilters={filters => handleFilters(filters, 'menCategory')}
            />
            <br />
            <br />
            <RadioButton
